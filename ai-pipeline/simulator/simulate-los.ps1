# Drone LOS Stream Simulator (Windows PowerShell)
# Simulates a Line Of Sight (LOS) drone stream via RTSP protocol

param(
    [string]$VideoPath = ".\test-video.mp4",
    [string]$StreamUrl = "rtmp://localhost:1935/drone-01-los",
    [int]$Fps = 30,
...
Write-Host "Starting LOS stream simulation..." -ForegroundColor Green
